...
(function ($, window, document, undefined) {
    ...
    Plugin.prototype.init = function () { // initialization function
        ...
        this.element
            .attr({
                'id': id,
                //set tabindex="-1" to be sure the bar itself is not keyboard focusable by default
        ...
        this.notification = $('<div/>') // add div element to be used to notify about the status of download
            // Add live region attributes so when space/Enter are pressed and the progress percent is added, or "Loading Complete!" is added, they are read aloud by the screen reader.
            .attr({
